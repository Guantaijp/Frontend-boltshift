...
import {signOutAsyc} from "../store/reducers/auth.reducer.ts";
...
const Popover = () => {
    ...
    const handleSignOut = async () => {
        try {
            await dispatch(signOutAsyc() as any);
            navigate("/login");
    ...
    return (
        ...
        <Dialog.Root>
            <Dialog.Trigger asChild>
                <div
                    className="group gap-2 p-4 data-[highlighted]:bg-[#FFF0FB]  text-[13px] leading-none text-sm font-medium text-left text-[#344054] flex items-center relative pl-[10px] select-none outline-none data-[disabled]:text-mauve8 data-[disabled]:pointer-events-none rounded-xl hover:bg-[#FFF0FB] hover:text-[] hover:text-[#66004B]">
                ...
                <Dialog.Content
                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="mx-3 flex flex-col justify-start items-start flex-grow relative gap-1">
                            <Dialog.Title
                                className="self-stretch flex-grow-0 flex-shrink-0  text-lg font-semibold text-left text-[#101828]">
                                Log Out
                            </Dialog.Title>
                            <Dialog.Description
                                className="self-stretch flex-grow-0 flex-shrink-0 text-sm text-left text-[#475467]">
                    ...
                    <div
                        className="self-stretch  flex-shrink-0  pl-[88px] pr-6 mt-8  flex justify-end items-center flex-grow gap-3">
