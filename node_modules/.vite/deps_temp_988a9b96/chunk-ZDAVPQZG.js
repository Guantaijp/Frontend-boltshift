import {
  ...
  Combination_default,
  hideOthers
} from "./chunk-OA6CSK7B.js";
import {
  $addc16e1bbe58fd0$export$3a72a57244d6e765
} from "./chunk-ZT5N35BD.js";
import {
  $1746a345f3d73bb7$export$f680877a34711e37
} from "./chunk-OA3DHR6O.js";
import {
  $921a889cee6df7e8$export$99c2b779aa4e8b8b
} from "./chunk-4IIJQW75.js";
import {
  $71cd76cc60e0454e$export$6f32135080cb4c3
} from "./chunk-H7MBXE56.js";
import {
...
var $5cb92bef7577960e$var$DismissableLayerContext = (0, import_react.createContext)({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
var $5cb92bef7577960e$export$177fb62ff3ec1f22 = (0, import_react.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, layerProps, {
    ref: composedRefs,
    style: {
...
var $5cb92bef7577960e$export$4d5eb2109db14228 = (0, import_react.forwardRef)((props, forwardedRef) => {
  const context = (0, import_react.useContext)($5cb92bef7577960e$var$DismissableLayerContext);
  ...
  return (0, import_react.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, props, {
    ref: composedRefs
  }));
});
...
var $5d3850c4d0b4e6c7$export$3ddf2d174ce01153 = (props) => {
  ...
  return (0, import_react4.createElement)($5d3850c4d0b4e6c7$var$DialogProvider, {
    scope: __scopeDialog,
    triggerRef,
    contentRef,
...
var $5d3850c4d0b4e6c7$export$2e1e1122cf0cba88 = (0, import_react4.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, ...triggerProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$TRIGGER_NAME, __scopeDialog);
  const composedTriggerRef = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, context.triggerRef);
  return (0, import_react4.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.button, _extends({
    type: "button",
...
var $5d3850c4d0b4e6c7$export$dad7c95542bacce0 = (props) => {
  ...
  return (0, import_react4.createElement)($5d3850c4d0b4e6c7$var$PortalProvider, {
    scope: __scopeDialog,
    forceMount
  }, import_react4.Children.map(
    children,
    (child) => (0, import_react4.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
...
var $5d3850c4d0b4e6c7$export$bd1d06c79be19e17 = (0, import_react4.forwardRef)((props, forwardedRef) => {
  const portalContext = $5d3850c4d0b4e6c7$var$usePortalContext($5d3850c4d0b4e6c7$var$OVERLAY_NAME, props.__scopeDialog);
  const { forceMount = portalContext.forceMount, ...overlayProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$OVERLAY_NAME, props.__scopeDialog);
  return context.modal ? (0, import_react4.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
    present: forceMount || context.open
  }, (0, import_react4.createElement)($5d3850c4d0b4e6c7$var$DialogOverlayImpl, _extends({}, overlayProps, {
    ref: forwardedRef
  }))) : null;
});
...
var $5d3850c4d0b4e6c7$var$DialogOverlayImpl = (0, import_react4.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, ...overlayProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$OVERLAY_NAME, __scopeDialog);
  return (
    // Make sure `Content` is scrollable even when it doesn't live inside `RemoveScroll`
    // ie. when `Overlay` and `Content` are siblings
    (0, import_react4.createElement)(Combination_default, {
...
var $5d3850c4d0b4e6c7$export$b6d9565de1e068cf = (0, import_react4.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react4.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
    present: forceMount || context.open
  }, context.modal ? (0, import_react4.createElement)($5d3850c4d0b4e6c7$var$DialogContentModal, _extends({}, contentProps, {
    ref: forwardedRef
  })) : (0, import_react4.createElement)($5d3850c4d0b4e6c7$var$DialogContentNonModal, _extends({}, contentProps, {
    ref: forwardedRef
  })));
});
...
var $5d3850c4d0b4e6c7$var$DialogContentModal = (0, import_react4.forwardRef)((props, forwardedRef) => {
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog);
  const contentRef = (0, import_react4.useRef)(null);
  ...
  return (0, import_react4.createElement)($5d3850c4d0b4e6c7$var$DialogContentImpl, _extends({}, props, {
    ref: composedRefs,
...
var $5d3850c4d0b4e6c7$var$DialogContentNonModal = (0, import_react4.forwardRef)((props, forwardedRef) => {
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog);
...
var $5d3850c4d0b4e6c7$var$DialogContentImpl = (0, import_react4.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, trapFocus, onOpenAutoFocus, onCloseAutoFocus, ...contentProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, __scopeDialog);
  const contentRef = (0, import_react4.useRef)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, contentRef);
  $3db38b7d1fb3fe6a$export$b7ece24a22aeda8c();
  return (0, import_react4.createElement)(import_react4.Fragment, null, (0, import_react4.createElement)($d3863c46a17e8a28$export$20e40289641fbbb6, {
    asChild: true,
    loop: true,
    trapped: trapFocus,
    onMountAutoFocus: onOpenAutoFocus,
    onUnmountAutoFocus: onCloseAutoFocus
  }, (0, import_react4.createElement)($5cb92bef7577960e$export$177fb62ff3ec1f22, _extends({
    role: "dialog",
...
var $5d3850c4d0b4e6c7$export$16f7638e4a34b909 = (0, import_react4.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, ...titleProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$TITLE_NAME, __scopeDialog);
  return (0, import_react4.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.h2, _extends({
    id: context.titleId
  }, titleProps, {
    ref: forwardedRef
  }));
...
var $5d3850c4d0b4e6c7$export$94e94c2ec2c954d5 = (0, import_react4.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, ...descriptionProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$DESCRIPTION_NAME, __scopeDialog);
  return (0, import_react4.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.p, _extends({
...
var $5d3850c4d0b4e6c7$export$fba2fb7cd781b7ac = (0, import_react4.forwardRef)((props, forwardedRef) => {
...
//# sourceMappingURL=chunk-ZDAVPQZG.js.map
