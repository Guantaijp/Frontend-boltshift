...
$parcel$export(module.exports, "Item", () => $3114c2382242bdc0$export$6d08773d2e66f8f2);
...
class $3114c2382242bdc0$export$b34a105447964f9f extends $3114c2382242bdc0$var$BaseNode {
   ...
   */ getMutableNode(element) {
    ...
    updateCollection() {
        for (let element of this.dirtyNodes)if (element instanceof $3114c2382242bdc0$export$dc064fe9e59310fd && element.parentNode) element.updateNode();
...
function $3114c2382242bdc0$var$Item(props, ref) {
    return $3114c2382242bdc0$export$e7c29ae2353b16ea("item", props, ref, props.children);
}
const $3114c2382242bdc0$export$6d08773d2e66f8f2 = /*#__PURE__*/ (0, $bzgmy$react.forwardRef)($3114c2382242bdc0$var$Item);
...
function $3f539f26b167ddde$var$CalendarCell({ date: date, ...otherProps }, ref) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement("td", cellProps, /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement("div", {
...
function $e733553516d848a9$var$Checkbox(props, ref) {
    ...
    }, groupState, ref) : (0, $bzgmy$reactaria.useCheckbox)({
        ...props,
        children: typeof props.children === "function" ? true : props.children
...
function $61e2b7078adb18bc$var$PopoverInner({ state: state, isExiting: isExiting, ...props }) {
    ...
    let isEntering = (0, $c5ccf687772c0422$export$6d3443f2c48bfc20)(ref, !!placement);
    let renderProps = (0, $c5ccf687772c0422$export$4d86445c2cf5e3)({
        ...props,
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement((0, $bzgmy$reactaria.Overlay), {
        isExiting: isExiting
    }, !props.isNonModal && /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement("div", {
        ...underlayProps,
        style: {
            position: "fixed",
            inset: 0
...
function $132cbde493282f82$var$GridListInner({ props: props, collection: collection, gridListRef: ref }) {
    ...
    let children = (0, $3114c2382242bdc0$export$727c8fc270210f13)({
        ...
        children: (item)=>{
            switch(item.type){
                case "item":
                    return /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement($132cbde493282f82$var$GridListItem, {
                        item: item
                    });
                default:
    ...
    if (state.collection.size === 0 && props.renderEmptyState) {
        ...
        if ((0, $bzgmy$reactariautils.isWebKit)()) {
            // For now, when in an empty state, swap the role to group in webkit.
            emptyStatePropOverrides = {
                role: "group",
                "aria-multiselectable": undefined
            };
            if ((0, $bzgmy$reactariautils.isIOS)()) // iOS VoiceOver also doesn't announce the aria-label of group elements
            // so try to add a visually hidden label element as well.
            emptyState = /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement((0, ($parcel$interopDefault($bzgmy$react))).Fragment, null, /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement((0, $bzgmy$reactaria.VisuallyHidden), null, gridProps["aria-label"]), content);
            else emptyState = content;
        } else emptyState = /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement("div", {
            role: "row",
            style: {
                display: "contents"
            }
...
function $132cbde493282f82$var$GridListItem({ item: item }) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement((0, ($parcel$interopDefault($bzgmy$react))).Fragment, null, (dragAndDropHooks === null || dragAndDropHooks === void 0 ? void 0 : dragAndDropHooks.useDropIndicator) && renderDropIndicator({
        ...
        "data-selection-mode": state.selectionManager.selectionMode === "none" ? undefined : state.selectionManager.selectionMode
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement("div", gridCellProps, /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement((0, $c5ccf687772c0422$export$2881499e37b75b9a), {
        values: [
            [
        ...
        children: (item)=>{
            switch(item.type){
                ...
                case "separator":
                    return /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement((0, $54b202ace195eaa4$export$1ff3c3f08ae963c0), item.props);
                case "item":
                    return /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement($a8f6e7d095d1cc86$var$MenuItem, {
                        item: item
                    });
                default:
                    throw new Error("Unsupported node type in Menu: " + item.type);
...
function $1456b76f687bd4ed$var$Radio(props, ref) {
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement("label", {
        ...(0, $bzgmy$reactariautils.mergeProps)(DOMProps, pressProps, hoverProps, renderProps),
        "data-selected": isSelected || undefined,
        "data-pressed": pressed || undefined,
        "data-hovered": isHovered || undefined,
        "data-focused": isFocused || undefined,
...
function $37b9a5d4bd0d4ded$var$Column(props, ref) {
    let render = (0, $bzgmy$react.useContext)((0, $3114c2382242bdc0$export$4feb769f8ddf26c5));
    let childColumns;
    ...
    var _props_title;
    return (0, $3114c2382242bdc0$export$e7c29ae2353b16ea)("column", props, ref, (_props_title = props.title) !== null && _props_title !== void 0 ? _props_title : props.children, children);
}
/**
...
function $37b9a5d4bd0d4ded$var$TableBodyRowGroup({ collection: collection, isDroppable: isDroppable }) {
    ...
    let emptyState;
    if (collection.size === 0 && props.renderEmptyState) emptyState = /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement("tr", {
        role: "row"
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement("td", {
        role: "gridcell",
...
function $37b9a5d4bd0d4ded$var$ColumnResizer(props, ref) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($bzgmy$react))).createElement("div", {
        ...
        ref: inputRef,
        ...(0, $bzgmy$reactaria.mergeProps)(inputProps, focusProps, hoverProps)
